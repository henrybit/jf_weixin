...
public class NewsMsg extends BaseMsg {
    ...
    private List<OldArticle> articles;

    public NewsMsg() {
        this.articles = new ArrayList<OldArticle>(maxSize);
    }
    ...
    public NewsMsg(List<OldArticle> articles) {
    ...
    public List<OldArticle> getArticles() {
        return articles;
    }

    public void setArticles(List<OldArticle> articles) {
    ...
    public void add(String title, String picUrl, String url) {
        add(new OldArticle(title, null, picUrl, url));
    }

    public void add(String title, String description, String picUrl, String url) {
        add(new OldArticle(title, description, picUrl, url));
    }

    public void add(OldArticle article) {
