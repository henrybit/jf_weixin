package com.github.jf.fastweixin.servlet;

import com.github.jf.fastweixin.handle.EventHandle;
import com.github.jf.fastweixin.entity.message.aes.AesException;
import com.github.jf.fastweixin.entity.message.aes.WXBizMsgCrypt;
import com.github.jf.fastweixin.entity.message.req.*;
import com.github.jf.fastweixin.util.BeanUtil;
import com.github.jf.fastweixin.util.SignUtil;
import com.github.jf.fastweixin.handle.MessageHandle;
import com.github.jf.fastweixin.entity.message.BaseMsg;
import com.github.jf.fastweixin.entity.message.TextMsg;
import com.github.jf.fastweixin.util.MessageUtil;
...
import static com.github.jf.fastweixin.util.CollectionUtil.isEmpty;
import static com.github.jf.fastweixin.util.CollectionUtil.isNotEmpty;
import static com.github.jf.fastweixin.util.StringUtil.isNotBlank;
...
//    protected String fromUserName, toUserName;
    ...
    public String processRequest(HttpServletRequest request) {
        ...
        if (BeanUtil.nonNull(msg)) {
            ...
            result = msg.toXml();
            if (StringUtil.isNotBlank(getAESKey())) {
                try {
