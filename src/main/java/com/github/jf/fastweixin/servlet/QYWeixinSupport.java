...
import com.github.jf.fastweixin.company.handle.QYEventHandle;
import com.github.jf.fastweixin.company.message.req.*;
import com.github.jf.fastweixin.company.message.resp.QYTextRespMsg;
...
import com.github.jf.fastweixin.company.handle.QYMessageHandle;
import com.github.jf.fastweixin.util.CollectionUtil;
import com.github.jf.fastweixin.util.MessageUtil;
import com.github.jf.fastweixin.util.StringUtil;
import com.github.jf.fastweixin.company.message.resp.QYBaseRespMsg;
...
//    private WXBizMsgCrypt wxcpt;
    ...
    public void bindServer(HttpServletRequest request, HttpServletResponse response){
        ...
        if(StringUtil.isBlank(getToken()) || StringUtil.isBlank(getAESKey()) || StringUtil.isBlank(getCropId())){
            pw.write("");
            pw.flush();
            pw.close();
        }
