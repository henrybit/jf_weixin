...
import com.github.jf.weixin.company.api.*;
import com.github.jf.weixin.company.api.entity.*;
import com.github.jf.weixin.company.api.enums.QYMenuType;
import com.github.jf.weixin.company.api.response.*;
import com.github.jf.weixin.company.message.QYNewsMsg;
import com.github.jf.weixin.enums.MediaType;
import com.github.jf.weixin.company.api.config.QYAPIConfig;
import com.github.jf.weixin.company.api.enums.QYResultType;
import com.github.jf.weixin.company.message.QYOldArticle;
import com.github.jf.weixin.company.message.QYTextMsg;
...
//    @Test
    public void sendNewsMessage() {
        ...
        msg.setMsgType("news");
        msg.setAgentId("1");
        QYOldArticle article = new QYOldArticle("t", "d", "p", "u");
        QYOldArticle article2 = new QYOldArticle("t2", "d2", "p2", "u2");
